...
*/
  ...
  fun `test author contents is preserved after a student closes and opens the project`() {
    ...
    val storage = StudyTaskManager.getInstance(studentProject).authorContentsStorage
    println(storage)
    ...
    val storage2 = StudyTaskManager.getInstance(studentProject2).authorContentsStorage
    println(storage2)
