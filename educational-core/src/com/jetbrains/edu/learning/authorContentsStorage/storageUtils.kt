...
class FileContentsHolderInProjectStorage(private val eduFile: EduFile) : FileContentsHolder {

  private val storage: AuthorContentsStorage?
    get() {
  ...
  private val path: String
    get() = pathInAuthorContentsStorageForEduFile(eduFile)
