...
fun readCourseJson(jsonText: String, authorContentStorageFactory: AuthorContentStorageFactory<*>): Course? {
  return try {
...
fun getCourseMapper(authorContentStorageFactory: AuthorContentStorageFactory<*>): ObjectMapper {
  return JsonMapper.builder()
    ...
    .setDateFormat()
    .injectableValues(InjectableValues.Std(mapOf(AUTHOR_CONTENTS_STORAGE_FACTORY_INJECTION_KEY to authorContentStorageFactory)))
    .build()
}
