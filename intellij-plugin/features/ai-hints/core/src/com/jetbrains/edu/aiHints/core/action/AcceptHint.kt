...
class AcceptHint : ApplyCodeAction() {
  ...
  override fun showSuccessfulNotification(project: Project) = EduNotificationManager.showInfoNotification(
    project,
    @Suppress("DialogTitleCapitalization") EduAIHintsCoreBundle.message("action.Educational.Hints.AcceptHint.notification.success.title"),
    EduAIHintsCoreBundle.message("action.Educational.Hints.AcceptHint.notification.success.text"),
  )
